...
import com.weizhang.adapter.WeizhangResponseAdapter;
...
public class WeizhangResult extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		popLoader = findViewById(R.id.popLoader);
	...
	private void updateUI() {
		...
		if (info.getStatus() == 2001) {
			...
			result_title.setText("共违章" + info.getCount() + "次, 计" + info.getTotal_score() + "分, 罚款 "
					+ info.getTotal_money() + "元");
